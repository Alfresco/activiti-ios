...
class MaterialDesignColorSchemeComponent: NSObject {
    ...
    override init() {
        ...
        self.flatButtonWithBackgroundScheme.typographyScheme = self.defaultTypographyScheme
        ...
        self.highlighterFlatButtonWithBackgroundScheme.typographyScheme = self.defaultTypographyScheme
